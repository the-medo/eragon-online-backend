CREATE OR REPLACE PROCEDURE delete_entity_group_content(_id integer, _entity_id integer, _entity_group_id integer, _delete_type delete_entity_group_content_action)
    LANGUAGE plpgsql AS $$
DECLARE
