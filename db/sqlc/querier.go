...
type Querier interface {
	...
	GetEntitiesByIDs(ctx context.Context, entityIds []int32) ([]Entity, error)
	...
	GetModuleById(ctx context.Context, moduleID int32) (Module, error)
	...
	GetModulesByIDs(ctx context.Context, moduleIds []int32) ([]Module, error)
