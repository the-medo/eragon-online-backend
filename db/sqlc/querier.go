...
type Querier interface {
	...
	GetCharacterByID(ctx context.Context, characterID int32) (Character, error)
	GetCharacters(ctx context.Context, arg GetCharactersParams) ([]ViewCharacter, error)
	GetCharactersByIDs(ctx context.Context, characterIds []int32) ([]Character, error)
	GetCharactersCount(ctx context.Context, arg GetCharactersCountParams) (int64, error)
	...
	GetEntityGroupsByIDs(ctx context.Context, entityGroupIds []int32) ([]EntityGroup, error)
	...
	GetRecursiveEntities(ctx context.Context, entityGroupID int32) ([]EntityGroupContent, error)
	GetSession(ctx context.Context, id uuid.UUID) (Session, error)
	GetSystemByID(ctx context.Context, systemID int32) (System, error)
	GetSystems(ctx context.Context, arg GetSystemsParams) ([]ViewSystem, error)
	GetSystemsByIDs(ctx context.Context, systemIds []int32) ([]System, error)
	GetSystemsCount(ctx context.Context, arg GetSystemsCountParams) (int64, error)
