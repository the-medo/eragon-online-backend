...
// 	protoc        v4.22.0
// source: services/chat/rpc_chat.proto
...
func (x *AddChatMessageRequest) Reset() {
	*x = AddChatMessageRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_chat_rpc_chat_proto_msgTypes[0]
...
func (*AddChatMessageRequest) Descriptor() ([]byte, []int) {
	return file_services_chat_rpc_chat_proto_rawDescGZIP(), []int{0}
}
...
func (x *AddChatMessageResponse) Reset() {
	*x = AddChatMessageResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_chat_rpc_chat_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AddChatMessageResponse) Descriptor() ([]byte, []int) {
	return file_services_chat_rpc_chat_proto_rawDescGZIP(), []int{1}
}
...
func (x *DeleteChatMessageRequest) Reset() {
	*x = DeleteChatMessageRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_chat_rpc_chat_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteChatMessageRequest) Descriptor() ([]byte, []int) {
	return file_services_chat_rpc_chat_proto_rawDescGZIP(), []int{2}
}
...
func (x *DeleteChatMessageResponse) Reset() {
	*x = DeleteChatMessageResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_chat_rpc_chat_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteChatMessageResponse) Descriptor() ([]byte, []int) {
	return file_services_chat_rpc_chat_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetChatMessagesRequest) Reset() {
	*x = GetChatMessagesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_chat_rpc_chat_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetChatMessagesRequest) Descriptor() ([]byte, []int) {
	return file_services_chat_rpc_chat_proto_rawDescGZIP(), []int{4}
}
...
func (x *GetChatMessagesResponse) Reset() {
	*x = GetChatMessagesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_chat_rpc_chat_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetChatMessagesResponse) Descriptor() ([]byte, []int) {
	return file_services_chat_rpc_chat_proto_rawDescGZIP(), []int{5}
}
...
var File_services_chat_rpc_chat_proto protoreflect.FileDescriptor

var file_services_chat_rpc_chat_proto_rawDesc = []byte{
	,
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x65, 0x0a, 0x16, 0x47,
	...
	0x65, 0x74, 0x22, 0x46, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73,
	...
	0x52, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69,
...
var (
	file_services_chat_rpc_chat_proto_rawDescOnce sync.Once
	file_services_chat_rpc_chat_proto_rawDescData = file_services_chat_rpc_chat_proto_rawDesc
)

func file_services_chat_rpc_chat_proto_rawDescGZIP() []byte {
	file_services_chat_rpc_chat_proto_rawDescOnce.Do(func() {
		file_services_chat_rpc_chat_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_chat_rpc_chat_proto_rawDescData)
	})
	return file_services_chat_rpc_chat_proto_rawDescData
}

var file_services_chat_rpc_chat_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_services_chat_rpc_chat_proto_goTypes = []interface{}{
...
var file_services_chat_rpc_chat_proto_depIdxs = []int32{
...
func init() { file_services_chat_rpc_chat_proto_init() }
func file_services_chat_rpc_chat_proto_init() {
	if File_services_chat_rpc_chat_proto != nil {
		return
	}
	file_services_chat_chat_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_services_chat_rpc_chat_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_chat_rpc_chat_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_chat_rpc_chat_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_chat_rpc_chat_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_chat_rpc_chat_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_chat_rpc_chat_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_chat_rpc_chat_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_services_chat_rpc_chat_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_services_chat_rpc_chat_proto_goTypes,
		DependencyIndexes: file_services_chat_rpc_chat_proto_depIdxs,
		MessageInfos:      file_services_chat_rpc_chat_proto_msgTypes,
	}.Build()
	File_services_chat_rpc_chat_proto = out.File
	file_services_chat_rpc_chat_proto_rawDesc = nil
	file_services_chat_rpc_chat_proto_goTypes = nil
	file_services_chat_rpc_chat_proto_depIdxs = nil
}
