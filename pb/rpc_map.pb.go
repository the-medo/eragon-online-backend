...
var file_services_maps_rpc_map_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x73, 0x22, 0x85, 0x02, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x61,
	0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x6f, 0x64, 0x75,
...
var file_services_maps_rpc_map_proto_depIdxs = []int32{
	...
	23, // 2: pb.CreateMapResponse.map:type_name -> pb.ViewMap
	24, // 3: pb.CreateMapResponse.layer:type_name -> pb.ViewMapLayer
	24, // 4: pb.GetMapLayersResponse.layers:type_name -> pb.ViewMapLayer
	25, // 5: pb.GetMapPinTypesResponse.pinTypes:type_name -> pb.MapPinType
	26, // 6: pb.CreateMapPinTypeRequest.shape:type_name -> pb.PinShape
	26, // 7: pb.UpdateMapPinTypeRequest.shape:type_name -> pb.PinShape
	25, // 8: pb.UpdateMapPinTypeResponse.pinType:type_name -> pb.MapPinType
	27, // 9: pb.GetMapPinsResponse.pins:type_name -> pb.ViewMapPin
