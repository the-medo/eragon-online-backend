...
type UploadImageUserAvatarRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UploadImageUserAvatarRequest) Reset() {
	*x = UploadImageUserAvatarRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *UploadImageUserAvatarRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UploadImageUserAvatarRequest) ProtoMessage() {}

func (x *UploadImageUserAvatarRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_upload_image_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UploadImageUserAvatarRequest.ProtoReflect.Descriptor instead.
func (*UploadImageUserAvatarRequest) Descriptor() ([]byte, []int) {
	return file_rpc_upload_image_proto_rawDescGZIP(), []int{2}
}

func (x *UploadImageUserAvatarRequest) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *UploadImageUserAvatarRequest) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_rpc_upload_image_proto_rawDesc = []byte{
	...
	0x4a, 0x0a, 0x1c, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x55, 0x73,
	...
	0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x2a, 0x5a, 0x28, 0x67,
...
var file_rpc_upload_image_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_rpc_upload_image_proto_goTypes = []interface{}{
	...
	(*UploadImageUserAvatarRequest)(nil), // 2: pb.UploadImageUserAvatarRequest
	(*timestamppb.Timestamp)(nil),        // 3: google.protobuf.Timestamp
}
var file_rpc_upload_image_proto_depIdxs = []int32{
	3, // 0: pb.UploadImageResponse.uploadedAt:type_name -> google.protobuf.Timestamp
...
func file_rpc_upload_image_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_upload_image_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UploadImageUserAvatarRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
