...
func RegisterVerifyHandlerServer(ctx context.Context, mux *runtime.ServeMux, server VerifyServer) error {
	...
	mux.Handle("POST", pattern_Verify_VerifyEmail_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.Verify/VerifyEmail", runtime.WithHTTPPathPattern("/verify"))
		if err != nil {
...
// "VerifyClient" to call the correct interceptors.
func RegisterVerifyHandlerClient(ctx context.Context, mux *runtime.ServeMux, client VerifyClient) error {
	...
	mux.Handle("POST", pattern_Verify_VerifyEmail_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.Verify/VerifyEmail", runtime.WithHTTPPathPattern("/verify"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Verify_VerifyEmail_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"verify"}, ""))
)
