...
func (server *Server) GetPostsByPlacement(ctx context.Context, req *pb.GetPostsByPlacementRequest) (*pb.GetPostsByPlacementResponse, error) {
...
func validateGetPostsByPlacement(req *pb.GetPostsByPlacementRequest) (violations []*errdetails.BadRequest_FieldViolation) {
	...
	if err := validator.ValidatePostPlacementExtended(req.WorldId, req.QuestId, req.SystemId, req.CharacterId); err != nil {
