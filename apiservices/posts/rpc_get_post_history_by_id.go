...
func (server *api.Server) GetPostHistoryById(ctx context.Context, req *pb.GetPostHistoryByIdRequest) (*pb.HistoryPost, error) {
	...
	rsp := api.convertHistoryPost(post, postType)
